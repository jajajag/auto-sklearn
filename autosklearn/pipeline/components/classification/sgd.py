...
class SGD(
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        #                                 default_value=1e-4)
        tol = UniformFloatHyperparameter("tol", 1e-4, 1.1e-4, log=True,
                                         default_value=1e-4)
